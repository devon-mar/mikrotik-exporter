...
func TestShouldParse(t *testing.T) {
	...
	assertDevice("192.168.1.1", "foo", "bar", c.Devices[0], t)
	assertDevice("192.168.2.1", "test", "123", c.Devices[1], t)
...
func assertDevice(address, user, password string, c Device, t *testing.T) {
